      ...
      <div className="container">
        ...
        <div className="row justify-content-between">
          ...
          <div className="col-12 col-md-3 text-center">
            ...
            <h5>Tendrás tu propio perfil para que los socios te conozcan mejor y sepan de tus logros.</h5>
          </div>
          <div className="col-12 col-md-3 text-center">
            ...
            <h5>Podrás organizar la rutina de ejercicios de los socios del gymnasio.</h5>
          </div>
        </div>
      </div>
      <br />
